...
<template>
    <div  class="login-container"  >
      <el-form ref="form" :model="form"    :rules="rules" class="login-page">
        ...
        <el-form-item class="login-input-box">
          <el-button type="primary" style=" width: 100%;font-size: 18px" @click="register" class="btn">密码重置</el-button>
        </el-form-item>
        <el-form-item>
          <el-button type="text" style="font-size: 16px"  @click="$router.push('/login')">前往登录>> </el-button>
        </el-form-item>
      </el-form>
    </div>
